    ...
    inquirer.prompt([
        {
            name: "product_ID",
            type: "input",
            message: "Enter product ID for the product."
        },
        {
            name: "stock",
            type: "input",
            message: "What is the quanity to be added?"
        }
    ]).then(function (answer) {
...
var addProduct = function () {
    inquirer.prompt([{
        ...
        type: "input",
        message: "What is the department should the product be shown in?"
    }, {
        name: "price",
        type: "input",
        ...
        name: "stock_quantity",
        type: "input",
        message: "What is the quanity you are adding?"
    }]).then(function (answer) {
